We are building a **terminal-based ASCII Chess game in Python**, designed to be **playable and fun**, but not a full commercial product.  The game strictly follows the official rules and notation standards of real chess.
